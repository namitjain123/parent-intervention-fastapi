...
export default function App() {
  ...
  const [hasLoaded, setHasLoaded] = useState(false); // ✅ prevent multiple calls
  ...
  useEffect(() => {
    // 🚨 CRITICAL: Prevent MSAL iframe infinite loop
    ...
    <div style={{ padding: 40, fontFamily: "Arial" }}>
      ...
      {!dashboard.pre_questionnaire_completed ? (
        <div>
          ...
          <p>
            Please complete the pre-questionnaire before accessing any episode.
          </p>
          <button onClick={openPreQuestionnaire}>
            Open Pre-questionnaire
          </button>
        </div>
      ) : (
        <div>
